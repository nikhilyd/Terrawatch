...
import { startScheduler }        from './scheduler/autoScan.scheduler';
...
import scanAnalysisRoutes from './routes/scanAnalysis.routes';
...
app.use('/api/scan',       scanAnalysisRoutes);        // Sentinel Hub + NDVI + GPT-4o (replaces ML service)
