...
exports.analyzeHistorical = void 0;
...
const analyzeHistorical = async (req, res) => {
    try {
        ...
        for (const dateStr of dates) {
            ...
            try {
                ...
                let imageData = await (0, sentinelHub_1.fetchImage)({ bbox, dateFrom, dateTo: dateStr, resolution });
                // Validate
...
exports.analyzeHistorical = analyzeHistorical;
//# sourceMappingURL=historicalAnalyze.controller.js.map