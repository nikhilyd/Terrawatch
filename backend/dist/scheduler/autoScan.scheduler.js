...
const publishScanJob = async (zoneId) => {
    try {
        ...
        (0, scanProcessor_1.processScanJob)(job).catch(err => console.error(`[${jobId}] Auto-scan failed:`, err));
    ...
    try {
        ...
        for (const scan of stuckScans) {
            ...
            await Scan_1.default.findByIdAndUpdate(scan._id, {
                status: 'failed',
                failedAt: new Date(),
                failReason: `Timeout: No response from processing service after ${TIMEOUT_MINUTES} minutes`,
            });
  ...
  <div style="background:#fff8f8;padding:25px;border:1px solid #ffcdd2">
    ...
    <table style="width:100%;border-collapse:collapse;margin:15px 0">
      ...
      <tr><td style="padding:8px;background:#f5f5f5;font-weight:bold">Reason</td>
          <td style="padding:8px;color:#c62828">Processing service did not complete within ${TIMEOUT_MINUTES} minutes</td></tr>
    </table>
...
//# sourceMappingURL=autoScan.scheduler.js.map