...
const processScanJob = async (job) => {
    console.log(`[${job.job_id}] Processing scan | zone=${job.zone_name} | ` +
    ...
    try {
        ...
        const imageData = await (0, sentinelHub_1.fetchImage)({
            bbox: job.bbox,
            dateFrom: job.date_from,
            dateTo: job.date_to,
            resolution: job.resolution,
        });
        console.log(`[${job.job_id}] Image fetched | ${imageData.width}x${imageData.height} | ` +
        ...
        console.log(`[${job.job_id}] NDVI | forest=${ndviResult.forestPct}% | ` +
        ...
        const origPath = (0, imageService_1.saveImage)(imageData.rgb, 'original', job.job_id);
        ...
        try {
            ...
            heatmapPath = (0, imageService_1.saveImage)(heatmapBuf, 'heatmap', job.job_id);
        }
        catch (hmErr) {
        ...
        console.log(`[${job.job_id}] Vision | threats=${JSON.stringify(vlResult.threats)} | ` +
        ...
        await (0, consumer_1.processScanResult)(scanResult);
        console.log(`[${job.job_id}] Scan complete | forest=${ndviResult.forestPct}% | ` +
        ...
        await (0, consumer_1.processScanResult)({
            job_id: job.job_id,
            zone_id: job.zone_id,
...
//# sourceMappingURL=scanProcessor.js.map