                ...
                >
                  <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
                    ...
                    <button 
                      ...
                      disabled={loadingAction !== null}
                      className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border border-white/5 bg-white/5 hover:bg-blue-500/10 hover:border-blue-500/30 transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {loadingAction === `kml-${zone._id}` ? (
                        <Loader2 size={24} className="text-blue-500 animate-spin" />
                      ) : (
                        <Globe2 size={24} className="text-zinc-400 group-hover:text-blue-400 transition-colors" />
                      )}
                      <span className="text-[10px] font-mono font-bold tracking-widest text-white group-hover:text-blue-400">Google Earth (KML)</span>
                    </button>
