                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                          ...
                          {zone.hasData ? (
                            <span className="text-[10px] font-mono text-blue-500/70 flex items-center gap-1">
                              <CheckCircle2 size={9} />
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <MetricCard label="Forest Cover"  value={`${zoneRisk.breakdown.forestPct.toFixed(1)}%`}
                    sub="latest scan" icon={Leaf} color="text-blue-400" />
                ...
                <div className="bg-gradient-to-br from-blue-900/20 to-black border border-blue-500/20 rounded-2xl p-5 relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-4 opacity-10">
                    <CloudRain size={100} />
                  </div>
                  <h3 className="text-sm font-mono uppercase tracking-widest text-blue-500 mb-4 flex items-center gap-2">
                    <CloudRain size={16} />
                  ...
                  {carbonLoss ? (
                    <>
                      ...
                      <div className="flex items-center gap-4 mb-4 text-[10px] font-mono text-zinc-500">
                        ...
                        <span>Scans: <span className="text-blue-400">{carbonLoss.period.scans} done</span></span>
