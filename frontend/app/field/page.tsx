    ...
    <div className="relative min-h-screen bg-[#020617] text-white px-4 md:px-8 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-12 relative z-10 pt-24 pb-20">
        ...
        >
          ...
          <p className="text-zinc-400 font-mono text-sm">Upload ground intelligence for real-time GPT-4o Vision AI verification.</p>
        </motion.div>
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  render={({ field }) => (
                    <select
                      ...
                      className={cn(
                        ...
                        errors.zoneId ? "border-red-500/50 focus:border-red-500" : "border-white/10 focus:border-blue-500/50"
                      )}
                    >
                    ...
                    {isMounted ? (
                      hasGps ? (
                        ...
                        <span className="text-red-400 font-mono text-xs flex items-center gap-2">
                          ...
                          {(geo.error as any).code === 1 ? "Location Denied" : (geo.error as any).code === 2 ? "Location Unavailable" : "GPS Error"}
                        </span>
                      ) : (
                ...
                <AnimatePresence mode="wait">
                  {photoPreview ? (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <button
                          ...
                          className="px-4 py-2 bg-black/80 border border-white/20 rounded-full text-xs font-mono uppercase hover:bg-blue-900 transition-colors flex items-center gap-2 text-white"
                        >
                    ...
                    <motion.button
                      ...
                      type="button"
                      onClick={handleCaptureClick}
                      className="w-full h-48 border-2 border-dashed border-white/10 hover:border-blue-500/50 rounded-xl bg-white/5 flex flex-col items-center justify-center gap-3 transition-colors group"
                    >
                      <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Camera className="text-blue-500" />
                      </div>
                      <span className="text-sm font-mono text-zinc-400 uppercase group-hover:text-blue-400 transition-colors">Tap to Capture Area</span>
                    </motion.button>
                  )}
                </AnimatePresence>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      {...field}
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-blue-500/50 min-h-[100px] resize-none transition-colors"
              ...
              <button
                ...
                className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-mono uppercase tracking-widest rounded-xl transition-colors shadow-[0_0_20px_rgba(59, 130, 246,0.2)] disabled:opacity-50 relative overflow-hidden group"
              >
            ...
            <div className="flex gap-2 mb-4 flex-wrap">
              {["ALL", "CRITICAL", "HIGH", "MEDIUM", "LOW"].map(level => {
                ...
                const colorClass =
                  ...
                  level === "LOW"      ? (isActive ? "bg-blue-500/20 border-blue-500/50 text-blue-300" : "border-blue-500/20 text-blue-500/50") :
                    ...
                    >
                      ...
                      <div className="p-4 border-b border-white/5 flex justify-between items-start">
                        ...
                        {report.status === "analyzed" ? (
                          <div className="flex items-center gap-1 text-xs font-mono text-blue-400 bg-blue-500/10 px-2 py-1 rounded border border-blue-500/20 shadow-[0_0_10px_rgba(59, 130, 246,0.2)]">
                            ...
                            <div className={cn(
                              ...
                              <div className="flex justify-between items-center mb-2">
                                <span className="text-xs font-mono text-white/70 uppercase flex items-center gap-1">
                                  <Crosshair size={12}/> GPT-4o Vision Analysis
                                </span>
                                <span className={cn(
